...
useEffect(() => {
  ...
  return (
    ...
    <>
      ...
      <div className={` bg-white items-center max-w-[500px] border lg:hidden  fixed bottom-0 z-50  w-full left-[50%] translate-x-[-50%] text-center rounded-t-xl 
      border-t-2 border-t-common-gray transition-all duration-300 ${!scrollTop && "translate-y-[100%]"}`}>
        <div className="flex justify-center rounded-full hidden ">
