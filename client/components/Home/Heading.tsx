...
const Heading = () => {
  ...
  return (
    <>
      ...
      <div className=" bg-white items-center max-w-[500px] border lg:hidden  fixed bottom-0 z-50  w-full left-[50%] translate-x-[-50%] text-center rounded-t-xl border-t-2 border-t-common-gray  ">
        <div className="flex justify-center rounded-full ">
          ...
          <div className="basis-[30%] flex px-2 pt-1 rounded-full justify-around  y bg-white ">
            <div className="flex items-center justify-center flex-col">
              <div className="nav__icon text-black">
                <BiEnvelope size={22} />
              </div>
