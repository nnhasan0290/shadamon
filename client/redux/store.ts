...
import { createCouponReducer, createPackageReducer, deletePackageReducer, editPackageReducer, getAllPackageReducer, getAllSortsReducer, getAllSubCatReducer } from "./reducers/admin/packageReducer";
...
const rootReducer = combineReducers({
  ...
  createPg: createPackageReducer,
  editPg: editPackageReducer,
  deletePg: deletePackageReducer,
  getAllSubCat: getAllSubCatReducer,
  allSorts: getAllSortsReducer,
